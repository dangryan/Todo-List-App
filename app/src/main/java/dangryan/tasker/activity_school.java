...
public class activity_school extends AppCompatActivity {
    private static final String TAG = "activity_school";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.query(
                ...
                TaskContract.TaskEntry.COL_TASK_CATEGORY + "= 'School'" + " AND " + TaskContract.TaskEntry.COL_TASK_TITLE + " IS NOT NULL",
                null,
                null,
                null,
                null);
    ...
    public void editTask(View view) {
        ...
        Intent intent = new Intent(activity_school.this, activity_edit_task.class);
    ...
    public void switchPage(View view){
        ...
        if (categoryChoice.equals("All")){
            Intent intent = new Intent(activity_school.this, MainActivity.class);
            startActivity(intent);
        }
        ...
        if (categoryChoice.equals("Work")){
            Intent intent = new Intent(activity_school.this, activity_work.class);
            startActivity(intent);

        }
        if (categoryChoice.equals("Personal")){
            Intent intent = new Intent(activity_school.this, activity_personal.class);
            startActivity(intent);
