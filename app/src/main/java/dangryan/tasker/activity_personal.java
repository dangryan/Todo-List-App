...
public class activity_personal extends AppCompatActivity {
    private static final String TAG = "activity_personal";
    ...
    public void editTask(View view) {
        ...
        Intent intent = new Intent(activity_personal.this, activity_edit_task.class);
    ...
    public void switchPage(View view){
        ...
        if (categoryChoice.equals("School")){
            Intent intent = new Intent(activity_personal.this, activity_school.class);
            startActivity(intent);
        }
        if (categoryChoice.equals("Work")){
            Intent intent = new Intent(activity_personal.this, activity_work.class);
            startActivity(intent);
