...
public class activity_completed extends AppCompatActivity {
        private static final String TAG = "activity_completed";
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Cursor cursor = db.query(
                    ...
                    TaskContract.TaskEntry.COL_TASK_DONE + "= 'True'",
                    null,
                    null,
                    null,
                    null);
        ...
        public void undoDeleteTask(View view) {
        View parent = (View) view.getParent();
        TextView taskTextView = (TextView) parent.findViewById(taskNameLabel);
        String task = taskTextView.getText().toString();
        SQLiteDatabase db = mHelper.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(TaskContract.TaskEntry.COL_TASK_DONE, "False");
        ...
        public void editTask(View view) {
            ...
            Intent intent = new Intent(dangryan.tasker.activity_completed.this, activity_edit_task.class);
